...
function empresaLlenaTabla(oData) {
	...
	$(oData).each(function() {
		$("#tabData").append("<tr class='item' style='cursor:pointer' onclick='editar(this)'><td>" + this.id + "</td><td>" + this.rut + "</td><td>" + this.giro + "</td><td>" + this.razonSocial + "</td><td>" + this.direccion + "</td><td>" + this.comuna + "</td><td>" + this.telefono + "</td></tr>");
	});
}
