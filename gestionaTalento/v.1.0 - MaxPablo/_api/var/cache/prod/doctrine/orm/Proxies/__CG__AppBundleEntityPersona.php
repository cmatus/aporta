...
class Persona extends \AppBundle\Entity\Persona implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Persona' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Persona' . "\0" . 'rut', '' . "\0" . 'AppBundle\\Entity\\Persona' . "\0" . 'nombre', '' . "\0" . 'AppBundle\\Entity\\Persona' . "\0" . 'apellidoPaterno', '' . "\0" . 'AppBundle\\Entity\\Persona' . "\0" . 'apellidoMaterno', '' . "\0" . 'AppBundle\\Entity\\Persona' . "\0" . 'correo', '' . "\0" . 'AppBundle\\Entity\\Persona' . "\0" . 'perfilId'];
        }
