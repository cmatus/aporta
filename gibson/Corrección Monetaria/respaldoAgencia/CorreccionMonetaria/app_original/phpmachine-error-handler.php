<?php
    ...
    /****************************************************************
    This script was developed by PHPMachine.com.  The original
    developer of the application (David Nicholson
    <dnicholson@phpmachine.com>) remains the owner of the code.  Any
    person may use this code in their own scripts as long as this
    file is not modified and this notice remains intact. To ensure
    that you have the latest version of this code please visit:
    ...
    ****************************************************************/
    ...
    $treejavascript = "<script language=\"JavaScript1.2\">
    <!--
