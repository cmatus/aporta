                                        ...
                                        <tr>
                                            <td align="left" width="200" valign="top">
                                                <table cellpadding="0" cellspacing="0" height="455">
                                                    ...
                                                    <tr><td background="images/manu.jpg" style="color:gray;font:bold bold 8pt tahoma;width:200px;height:35px;border-bottom:1px solid silver;border-top:0px solid silver;border-left:1px solid silver;border-right:0px solid silver" nowrap>&nbsp;&nbsp;&nbsp;Saldos finales</td></tr>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0">
                                                                ...
                                                                <?php
                                                                    ...
                                                                    while($row = mssql_fetch_array($result)){
                                                                        ...
                                                                        <td style='width:70px;color:gray;font:normal normal 7pt tahoma;border-top:0px solid silver;border-bottom:1px solid silver;border-right:1px solid silver;border-left:0px solid silver' align='center'><a href='cor010000.php?TIP=14&PLA=".trim($row["planta"])."' target='_blank'><img border=0 src='images/excel.jpg'></a><a href='cor010000.php?TIP=16&PLA=".trim($row["planta"])."' target='_blank'><img border=0 src='images/pdf.jpg'></a></td>
                                                                        </tr>";
                                                                        $liCount++;
